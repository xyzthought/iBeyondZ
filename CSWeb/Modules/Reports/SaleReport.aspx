<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleReport.aspx.cs" Inherits="Modules_Sale" %>
        ...
        <div class="main-table-wrapper">
            ...
            <div id="updMain">
                <div id="dvgridcontainer" class="grid_container">
                    ...
                    <br style="clear: both" />
                    <div style="float:right;padding-bottom:5px;font-weight:bolder">Total Sale : €<span id='spAmount' runat="server">0.00</span></div>
                    <br style="clear: both" />
                    <div class="grid_container">
                        <ctrl:CustomGridView ID="gvGrid" EmptyDataText="<span class='noDataSelected'>No Data Available</span>"
                            ...
                            EndDateCol="3" OnRowDataBound="gvGrid_RowDataBound" 
