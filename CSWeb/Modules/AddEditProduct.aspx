...
>>>>>>> 6b0487ec9674b28a7c0c9dfd5e2a5b2108f99b2e
                            ...
                            <div style="float: left; width: 278px;">
                                <div class="scroll_checkboxes">
                                    <asp:CheckBoxList ID="chkSize" CssClass="FormText" runat="server" RepeatDirection="Vertical"
                                        RepeatColumns="1" CellPadding="15" CellSpacing="5" BorderWidth="0">
                                    </asp:CheckBoxList>
                                </div>
                            </div>
                            <div style="float: left; padding-left: 8px;">
                                        ...
                                        <fieldset>
                                            <div class="grid_container">
                                                <ctrl:CustomGridView ID="gvSize" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                                    ...
                                                    OnRowUpdating="gvSize_RowUpdating" OnPageIndexChanging="gvSize_PageIndexChanging">
                                                    <EmptyDataTemplate>
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtSizeBarCode1" onblur="checkAlpaNumeric(this);" onkeyup="checkAlpaNumeric(this);"
                                                                        MaxLength="3" CssClass="txtMasterData" runat="server" Visible="true" />
                                                                    <asp:RequiredFieldValidator ValidationGroup="NewDSi" ID="RequiredFieldValidator1"
                                                                        runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtSizeBarCode1"
                                                                        Display="Dynamic"></asp:RequiredFieldValidator>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Size Bar Code">
                                                            ...
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtSizeBarCodeE" MaxLength="3" onblur="checkAlpaNumeric(this);"
                                                                    onkeyup="checkAlpaNumeric(this);" CssClass="txtMasterData" runat="server" Text='<%# Eval("SizeBarCode") %>' />
                                                            ...
                                                            <FooterTemplate>
                                                                <asp:TextBox ID="txtSizeBarCode" onblur="checkAlpaNumeric(this);" onkeyup="checkAlpaNumeric(this);"
                                                                    MaxLength="3" CssClass="txtMasterData" runat="server" />
                                        ...
                                        <fieldset>
                                            <div class="grid_container">
                                                <ctrl:CustomGridView ID="grvCategory" runat="server" AutoGenerateColumns="false"
                                                    ...
                                                    OnRowUpdating="grvCategory_RowUpdating" OnPageIndexChanging="grvCategory_PageIndexChanging">
                                                    <EmptyDataTemplate>
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <th>
                                        ...
                                        <fieldset>
                                            <div class="grid_container">
                                                <ctrl:CustomGridView ID="grvBrand" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                                    ...
                                                    OnRowEditing="grvBrand_RowEditing" OnRowUpdating="grvBrand_RowUpdating" OnPageIndexChanging="grvBrand_PageIndexChanging">
                                                    <EmptyDataTemplate>
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <th>
                                        ...
                                        <fieldset>
                                            <div class="grid_container">
                                                <ctrl:CustomGridView ID="grvSeason" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                                    ...
                                                    OnRowEditing="grvSeason_RowEditing" OnRowUpdating="grvSeason_RowUpdating" OnPageIndexChanging="grvSeason_PageIndexChanging">
                                                    <EmptyDataTemplate>
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <th>
