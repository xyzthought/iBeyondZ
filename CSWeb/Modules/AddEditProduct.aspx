                    ...
                    <div class="inner">
                        ...
                        <div>
                            ...
                            <asp:LinkButton ID="lnkAddSize" href="#" OnClientClick="ClearFormFields();ShowModalDiv('ModalWindow2','dvInnerWindow1',0)"
                                runat="server"><img alt="Add Size" title="Add Size" src="../Images/size.png" /></asp:LinkButton>
                        </div>
                        <div class="alt" style="margin-bottom: 5px;">
                        ...
                        <div style="float: left">
                            ...
                            <div class="alt" style="margin-bottom: 5px;">
                                <asp:TextBox ID="txtBuyingPrice" runat="server" onkeyup="extractNumber(this,-1,false);"
                                    onblur="extractNumber(this,-1,false);" CssClass="txtCred" Style="width: 160px!important"></asp:TextBox></td>
                        ...
                        <div style="float: left">
                            ...
                            <div class="alt" style="margin-bottom: 5px;">
                                <asp:TextBox onkeyup="extractNumber(this,-1,false);" onblur="extractNumber(this,-1,false);"
                        ...
                        <div style="clear: both">
                            ...
                            <div class="btn-wrapper4">
                                ...
                                <span class="btn">
                                    <asp:LinkButton ID="lnkCancel" runat="server" OnClientClick="return CloseAddDiv('ModalWindow1');"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        ...
                                                        <EditItemTemplate>
                                                            ...
                                                            <asp:ImageButton ID="imgbtnCancel" ImageUrl="../Images/cancel.png" runat="server"
